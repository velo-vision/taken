    ...
    <section class="content size">
      ...
      <div class="row">
        ...
        <div class="promociones col-xs-12 col-sm-12 col-md-12" >
          <div class="col-xs-6 col-sm-4 col-md-2 padding-no">
        ...
        <section >
           ...
           <!-- CONTENIDO -->
              <div class="row formatoPromocion">
                ...
                <form  >
                  <div class="col-xs-12 col-md-12">
                    <div class="col-xs-12 col-md-6 padding-no">
                  ...
                  <div class="col-xs-12 col-md-12">
                    ...
                    <div class="col-xs-12 col-md-4">
                      <div class="col-xs-12 col-md-5 padding-no">
                  ...
                  <div class="col-xs-12 col-md-12">
                    <div class="col-xs-8 col-md-6 padding-no">
